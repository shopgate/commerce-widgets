...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(mapStateToProps, 'mapStateToProps', 'frontend/src/ProductSlider/connector.js');

  __REACT_HOT_LOADER__.register(mapDispatchToProps, 'mapDispatchToProps', 'frontend/src/ProductSlider/connector.js');

  __REACT_HOT_LOADER__.register(_default, 'default', 'frontend/src/ProductSlider/connector.js');
}();
