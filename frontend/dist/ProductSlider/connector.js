...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(mapStateToProps, 'mapStateToProps', 'src/ProductSlider/connector.js');

  __REACT_HOT_LOADER__.register(mapDispatchToProps, 'mapDispatchToProps', 'src/ProductSlider/connector.js');

  __REACT_HOT_LOADER__.register(_default, 'default', 'src/ProductSlider/connector.js');
}();
